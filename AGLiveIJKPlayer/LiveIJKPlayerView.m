...
- (instancetype)initWithFrame:(CGRect)frame liveURLString:(NSString *)urlString {
    ...
    if (self) {
        ...
        // 加载状态改变
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(iJKMoviePlayerPlaybackStateDidChange:) name:IJKMoviePlayerPlaybackStateDidChangeNotification object:nil];
...
- (void)iJKMoviePlayerPlaybackStateDidChange:(NSNotification *)noti {
